...
namespace Licenta.Pages.Assistant.Predictions
{
    ...
    public class AssistantPredictionsCreatePageModel : PageModel
    {
        private readonly AppDbContext _db;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IWebHostEnvironment _env;

        public AssistantPredictionsCreatePageModel(AppDbContext db, UserManager<ApplicationUser> userManager, IWebHostEnvironment env)
        {
            _db = db;
        ...
        public async Task OnGetAsync(Guid? patientId) => await LoadAsync(patientId);
